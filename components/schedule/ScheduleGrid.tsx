...
export function ScheduleGrid({
  ...
  return (
    <>
      {/* Mobile Card Layout */}
      <div className="md:hidden flex-1 overflow-auto border border-black rounded-lg shadow-lg bg-white print:hidden" id="schedule-grid-mobile">
      ...
      <div className="hidden md:block flex-1 overflow-auto border border-black rounded-lg shadow-lg bg-white relative print:block print:border-none print:shadow-none print:overflow-visible" id="schedule-grid">
