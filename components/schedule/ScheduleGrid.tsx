          ...
          <thead className="bg-slate-50 sticky top-0 z-20 shadow-sm print:static print:bg-white print:shadow-none">
            ...
            <tr>
              {zones.map((zone, index) => (
                <th
                  key={`time-${zone.id}`}
                  className="border border-gray-300 p-1.5 text-center text-sm font-medium text-gray-800 print:text-[10px] print:border-black print:p-0.5"
                >
                  <input
                    type="text"
                    value={zone.time}
              ...
              <React.Fragment key={`${dayData.date}-${dayIndex}`}>
                {dayData.services.map((service, serviceIndex) => (
                  ...
                  >
                    ...
                    <td className="border border-gray-300 p-3 font-semibold text-gray-700 align-middle sticky left-[90px] z-10 bg-inherit text-center text-base print:static print:text-xs print:p-1 print:border-black">
                    ...
                    {zones.map((zone) => {
                      ...
                      return (
                        <td
                          key={zone.id}
                          className="border border-gray-300 p-1 text-center align-middle print:border-black print:p-0.5"
                        >
                          <div className="relative w-full h-full flex items-center justify-center">
                            ...
                            <span className="hidden print:flex items-center justify-center w-full h-full text-base font-medium text-gray-900 whitespace-normal break-words leading-tight px-0.5 min-h-[1.5em] print:text-xs">
                              {currentValue}
                            </span>
